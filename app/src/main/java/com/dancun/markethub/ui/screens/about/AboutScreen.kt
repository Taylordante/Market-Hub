package com.dancun.markethub.ui.screens.about
...
fun AboutScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "About Market Hub",
                style = MaterialTheme.typography.headlineMedium
            )
            Text(
                text = "Market Hub is your one-stop shop for everything you need. " +
