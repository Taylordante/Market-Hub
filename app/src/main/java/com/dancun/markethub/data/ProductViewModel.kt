package com.dancun.markethub.data
...
class ProductViewModel : ViewModel() {
    ...
    private val cloudinaryUrl = "https://api.cloudinary.com/v1_1/dmuv7kalo/image/upload"
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    navController.navigate(ROUT_HOME) // Fixed navigation route
                }
            } catch (e: Exception) {
                withContext(Dispatchers.Main) {
